...
Validar um padrão relacionado a PrivateLink, Network Firewall, WAF e Shield em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.

## Serviços sugeridos

PrivateLink, Network Firewall, WAF, Shield, Firewall Manager
