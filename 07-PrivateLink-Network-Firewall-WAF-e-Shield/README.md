...
Este módulo cobre exposição privada de serviços, proteção de borda, inspeção de tráfego e defesa centralizada, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Organizational Complexity / Security.
- Serviços e padrões principais: PrivateLink, Network Firewall, WAF, Shield, Firewall Manager.
