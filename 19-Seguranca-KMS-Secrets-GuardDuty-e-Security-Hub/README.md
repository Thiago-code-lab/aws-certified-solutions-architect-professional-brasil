...
- Modulo anterior: [CloudWatch CloudTrail Config e Observabilidade](../18-CloudWatch-CloudTrail-Config-e-Observabilidade/README.md)
...
- Proximo modulo: [Disaster Recovery Backup RTO e RPO](../20-Disaster-Recovery-Backup-RTO-e-RPO/README.md)
