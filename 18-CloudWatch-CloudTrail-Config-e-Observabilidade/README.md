...
Este módulo cobre telemetria, auditoria, conformidade, remediação automatizada e melhoria contínua, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Continuous Improvement.
- Serviços e padrões principais: CloudWatch, CloudTrail, Config, Systems Manager, X-Ray.
...
Para revisar CloudWatch, CloudTrail e monitoramento fundamental antes de aprofundar observabilidade, auditoria e remediação:
