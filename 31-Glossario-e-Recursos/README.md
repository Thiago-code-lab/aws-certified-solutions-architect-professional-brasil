...
Este módulo cobre termos, links oficiais, whitepapers, frameworks e trilhas complementares, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Revisão / Recursos.
- Serviços e padrões principais: Documentação AWS, Exam Guide, Well-Architected, whitepapers.
...
Use estas trilhas conforme a lacuna de revisão: Associate para base arquitetural, Cloud Practitioner para fundamentos de cloud e billing, e AI Practitioner para termos ligados a IA e workloads generativos.
