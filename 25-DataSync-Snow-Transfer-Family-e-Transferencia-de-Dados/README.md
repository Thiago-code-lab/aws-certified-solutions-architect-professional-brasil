...
- Modulo anterior: [MGN DMS SCT e Migracao de Workloads](../24-MGN-DMS-SCT-e-Migracao-de-Workloads/README.md)
...
- Proximo modulo: [Modernizacao Serverless Containers e Decoupling](../26-Modernizacao-Serverless-Containers-e-Decoupling/README.md)
