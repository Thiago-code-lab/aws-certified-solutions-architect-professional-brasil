# DataSync, Snow, Transfer Family e Transferência de Dados

## Visão Geral

Este módulo cobre movimentação de dados em escala, janelas limitadas, redes híbridas e custo de transferência, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Migration and Modernization.
- Serviços e padrões principais: DataSync, Snow Family, Transfer Family, Direct Connect, S3.
