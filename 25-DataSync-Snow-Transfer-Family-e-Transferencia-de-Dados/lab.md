...
Validar um padrão relacionado a DataSync, Snow, Transfer Family e Transferência de Dados em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.

## Serviços sugeridos

DataSync, Snow Family, Transfer Family, Direct Connect, S3
