...
Este módulo cobre gargalos, SLAs, KPIs, limites de serviço, self-healing e evolução controlada, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Continuous Improvement.
- Serviços e padrões principais: Service Quotas, CloudWatch, Auto Scaling, Trusted Advisor.
