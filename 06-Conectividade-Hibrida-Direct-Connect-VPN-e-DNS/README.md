# Conectividade Híbrida, Direct Connect, VPN e DNS

## Visão Geral

Este módulo cobre integração entre datacenters, múltiplas redes, DNS híbrido e requisitos de latência, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Organizational Complexity.
- Serviços e padrões principais: Direct Connect, Site-to-Site VPN, Route 53 Resolver, Transit Gateway.
...
Para revisar VPC, Route 53 e padrões básicos de conectividade antes de aprofundar conectividade híbrida, Direct Connect, VPN e DNS híbrido:
