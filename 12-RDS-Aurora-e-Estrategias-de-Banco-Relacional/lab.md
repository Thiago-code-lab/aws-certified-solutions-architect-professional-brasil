...
Validar um padrão relacionado a RDS, Aurora e Estratégias de Banco Relacional em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.

## Serviços sugeridos

RDS, Aurora, RDS Proxy, DMS, Backup
