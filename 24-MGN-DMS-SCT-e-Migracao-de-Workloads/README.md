# MGN, DMS, SCT e Migração de Workloads

## Visão Geral

Este módulo cobre migração de servidores, bancos, transformação de schema e redução de downtime, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Migration and Modernization.
- Serviços e padrões principais: Application Migration Service, DMS, SCT, EC2, RDS.
