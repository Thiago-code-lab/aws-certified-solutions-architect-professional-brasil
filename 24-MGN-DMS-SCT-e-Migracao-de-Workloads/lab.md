...
Validar um padrão relacionado a MGN, DMS, SCT e Migração de Workloads em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.

## Serviços sugeridos

Application Migration Service, DMS, SCT, EC2, RDS
