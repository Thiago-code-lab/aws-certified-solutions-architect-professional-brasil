...
Validar um padrão relacionado a Labs Práticos em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.

## Serviços sugeridos

Organizations, VPC, CloudWatch, IAM, Lambda, S3
