# EC2, Auto Scaling e Estratégias de Compute

## Visão Geral

Este módulo cobre seleção de compute, modelos de compra, elasticidade e redução de operação, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Design for New Solutions.
- Serviços e padrões principais: EC2, Auto Scaling, ELB, Savings Plans.
...
Para revisar EC2, Auto Scaling, ELB e modelos de compra antes de aprofundar estratégias de compute, elasticidade e modelos de compra:
