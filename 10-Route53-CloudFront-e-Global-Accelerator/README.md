...
Este módulo cobre roteamento global, entrega no edge, aceleração e resiliência para usuários distribuídos, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Design for New Solutions.
- Serviços e padrões principais: Route 53, CloudFront, Global Accelerator, WAF.
...
Para revisar Route 53, CloudFront e DNS fundamentals antes de aprofundar roteamento global, edge e aceleração:
