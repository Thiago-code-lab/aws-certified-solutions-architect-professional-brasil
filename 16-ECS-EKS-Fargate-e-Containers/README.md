...
Este módulo cobre orquestração, portabilidade, operação gerenciada e modernização de workloads, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Design for New Solutions.
- Serviços e padrões principais: ECS, EKS, Fargate, ECR, App Runner.
...
Para revisar ECS, EKS, Fargate e conceitos de containers AWS antes de aprofundar orquestração e modernização com containers:
