...
Validar um padrão relacionado a ECS, EKS, Fargate e Containers em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.

## Serviços sugeridos

ECS, EKS, Fargate, ECR, App Runner
