...
Este módulo cobre continuidade de negócio, failover, replicação e impacto operacional de arquiteturas distribuídas, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Design for New Solutions.
- Serviços e padrões principais: Route 53, ELB, Aurora, DynamoDB Global Tables, S3 CRR.
...
Para revisar Multi-AZ, backup, DR e resiliência básica antes de aprofundar alta disponibilidade, failover e desenho multi-Region:
