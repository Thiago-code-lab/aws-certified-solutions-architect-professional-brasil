...
Validar um padrão relacionado a Alta Disponibilidade, Multi-AZ e Multi-Region em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.

## Serviços sugeridos

Route 53, ELB, Aurora, DynamoDB Global Tables, S3 CRR
