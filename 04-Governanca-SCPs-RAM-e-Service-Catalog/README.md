# Governança, SCPs, RAM e Service Catalog

## Visão Geral

Este módulo cobre controles preventivos, compartilhamento de recursos e padronização de provisionamento, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Organizational Complexity.
- Serviços e padrões principais: Organizations, SCPs, RAM, Service Catalog, Config.
