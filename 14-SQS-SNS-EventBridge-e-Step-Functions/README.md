...
Este módulo cobre desacoplamento, orquestração, eventos, buffering e controle de falhas, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Design for New Solutions.
- Serviços e padrões principais: SQS, SNS, EventBridge, Step Functions, Amazon MQ.
...
Para revisar SQS, SNS e integração assíncrona antes de aprofundar desacoplamento, eventos e orquestração:
