...
Validar um padrão relacionado a Lambda, API Gateway e Arquiteturas Serverless em ambiente de estudo, com escopo pequeno, evidência observável e cleanup claro.
