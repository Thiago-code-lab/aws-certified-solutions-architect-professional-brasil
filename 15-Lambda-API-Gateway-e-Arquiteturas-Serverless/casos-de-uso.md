# Caso de Uso - Lambda API Gateway e Arquiteturas Serverless

## Cenario

Uma organizacao revisa uma arquitetura relacionada a Lambda API Gateway e Arquiteturas Serverless. A solucao precisa manter operacao continua, seguranca e custo controlado.
