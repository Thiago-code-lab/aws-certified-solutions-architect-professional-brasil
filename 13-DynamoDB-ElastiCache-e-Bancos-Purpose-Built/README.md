...
Este módulo cobre decisão entre bancos especializados, caching, padrões de acesso e escala operacional, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Design for New Solutions.
- Serviços e padrões principais: DynamoDB, ElastiCache, OpenSearch, DocumentDB, Neptune.
...
Para revisar DynamoDB, ElastiCache e modelagem básica antes de aprofundar bancos purpose-built, caching e padrões de acesso:
