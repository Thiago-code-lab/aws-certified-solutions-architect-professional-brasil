# Well-Architected e Trade-Offs Avançados

## Visão Geral

Este módulo cobre decisões entre pilares, exceções justificadas e evolução arquitetural com restrições reais, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Todos os domínios.
- Serviços e padrões principais: Well-Architected Tool, Trusted Advisor, Organizations, CloudWatch.
...
Para revisar Well-Architected e pilares arquiteturais básicos antes de aprofundar trade-offs avançados entre pilares do Well-Architected:
