...
Este módulo cobre estratégias de DR, testes, backup, replicação e recuperação alinhada a negócio, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Continuous Improvement.
- Serviços e padrões principais: AWS Backup, Elastic Disaster Recovery, Route 53, S3, Aurora.
...
Para revisar estratégias de DR e backup em nível Associate antes de aprofundar DR, backup, RTO/RPO e testes de recuperação:
