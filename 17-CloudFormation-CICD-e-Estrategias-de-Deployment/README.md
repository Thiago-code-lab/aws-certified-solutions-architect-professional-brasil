...
- Modulo anterior: [ECS EKS Fargate e Containers](../16-ECS-EKS-Fargate-e-Containers/README.md)
...
- Proximo modulo: [CloudWatch CloudTrail Config e Observabilidade](../18-CloudWatch-CloudTrail-Config-e-Observabilidade/README.md)
