...
Este módulo cobre mentalidade profissional, leitura de cenários longos e priorização de restrições conflitantes, com foco no tipo de raciocínio arquitetural exigido no AWS Certified Solutions Architect Professional (SAP-C02).

## Conceitos-Chave

- Domínio predominante: Base / Estratégia.
- Serviços e padrões principais: AWS Organizations, IAM, VPC, Route 53, CloudWatch, Well-Architected.
...
Para revisar fundamentos de arquitetura AWS antes de aprofundar a leitura de cenários SAP-C02 e a transição para raciocínio Professional:

https://github.com/Thiago-code-lab/aws-certified-solutions-architect-associate-brasil

Se precisar reforçar billing, pricing, responsabilidade compartilhada ou fundamentos de cloud relacionados a este tema:
